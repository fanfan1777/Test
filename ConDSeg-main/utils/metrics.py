...
# ==============================================================================
class UtralSoundConsistencyLoss(nn.Module):
    """
    包含了针对超声图像优化的三种一致性损失：
    ...
    def __init__(self, weight_skl=10.0, weight_grad=1.0, weight_freq=0.1):
        super(UtralSoundConsistencyLoss, self).__init__()
    ...
    def forward(self, pred1, pred2):
        ...
        """
        loss_skl = self.soft_kl_loss(pred1, pred2)
...
class SDFConsistencyLoss(nn.Module):
    ...
    def forward(self, sdf1, sdf2):
        ...
        """
        # 直接计算 MSE Loss
        loss = F.mse_loss(sdf1, sdf2, reduction='mean')
